...
namespace socialNet::social_graph {
        ...
        class MysqlSocialGraphDatabase : public SocialGraphDatabase {
        private:
        ...
        private:
                ...
                std::shared_ptr <utils::MysqlClient::Statement> prepareFindSubscriptions (uint32_t * resId, uint32_t *uid, uint32_t *page, uint32_t *nb);
                std::shared_ptr <utils::MysqlClient::Statement> prepareFindFollowers (uint32_t * resId, uint32_t *uid, uint32_t *page, uint32_t *nb);
        };
